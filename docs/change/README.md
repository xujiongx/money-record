...
| SSGOI 路由过渡 | 2026-09-03 | 接入 `@ssgoi/react`；成员列表可发现性；**lucide-react** + **`BackLink`**；记账时间：快捷日 + **react-mobile-picker** 滚轮 | [2026-09-03.md](./2026-09-03.md) |
| 更多功能 / 大事记账 | 2026-09-06 | 成员页「更多功能」→ `/tools`；**大事记账**独立表与日常账本隔离；成员区分 + 分类/成员分析 | [2026-09-06.md](./2026-09-06.md) |
| （在此登记） | | | |
